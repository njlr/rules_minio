...
some other ruleset that depends on rules_minio, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_minio=$(pwd)/rules_minio"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_minio` on your system will point to this folder.
...
https://github.com/myorg/rules_minio/actions/workflows/tag.yaml
