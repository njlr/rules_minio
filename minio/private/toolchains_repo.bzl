...
# By default all these toolchains are registered by the minio_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:minio_toolchain",
    toolchain_type = "@rules_minio//minio:toolchain_type",
)
""".format(
            platform = platform,
